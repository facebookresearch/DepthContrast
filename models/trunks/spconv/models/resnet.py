...
from models.trunks.spconv.models.model import Model
from models.trunks.spconv.models.modules.common import ConvType, NormType, get_norm, conv, sum_pool
...
class ResNetBase(Model):
  ...
  def __init__(self, in_channels=1, out_channels=1, D=3, **kwargs):
